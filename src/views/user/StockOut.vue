<template>
  <div class="w-full h-full background">
      <Header></Header>
      <div class="flex">
        <Sidebar :page="'stock-out'"></Sidebar>
        <div class="pad mx-auto mt-7">
            <span class="flex header-text text-4xl font-th mb-3">รายการสินค้าส่งออก</span>
...
export default {
    ...
    methods:{
        ...
        removeStock(id){
            Swal.fire({
                icon:'question',
                title: '<span class="text-red-500 font-eng">ลบรายการส่งออก</span>', 
                text: 'คุณต้องการลบรายการส่งออกใช่หรือไม่',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'ใช่',
