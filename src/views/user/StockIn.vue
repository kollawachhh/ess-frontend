<template>
  <div class="w-full h-full background">
      <Header></Header>
      <div class="flex">
        <Sidebar :page="'stock-in'"></Sidebar>
        <div class="pad mx-auto mt-7">
            <span class="flex header-text text-4xl font-th mb-3">รายการสินค้านำเข้า</span>
            ...
            <div class="wrapper-content w-full mt-8">
                <div class="flex w-full px-5 py-8 font-th">
                    <button class="button rounded-md h-10 ml-auto px-6" @click="addStock">เพิ่มรายการสินค้านำเข้า - ส่งออก</button>
                </div>
                <div class="w-full px-5">
                    <table class="w-full">
                        ...
                        <div class="flex table-body w-full overflow-y-scroll">
                            <tbody class="w-full">
                                    <tr class="flex h-10 border-b-2 py-2 text-sm" v-for="(stock, index) in allStockIn" :key="index">
        ...
        showDetail(stock){
            Swal.fire({
                ...
                html: '<div class="w-80 mx-auto">' +'\n' + 
                        ...
                        '<br>' + '<span class="flex font-th">' + 'ประเภท : '+ stock.goods.type + '</span>' + '\n' +
                        '<br>' + '<span class="flex font-th">' + 'ป้อนข้อมูล : '+ stock.input + '</span>' + '\n' +
                        ...
                        '<br>' + '<span class="flex font-th">' + 'รับผิดชอบ : '+ stock.responsible + '</span>'+ '\n' +
                      '</div>',
            })
        },
        removeStock(id){
            Swal.fire({
                icon:'question',
                title: '<span class="text-red-500 font-eng">ลบรายการนำเข้า</span>', 
                text: 'คุณต้องการลบรายการนำเข้าใช่หรือไม่',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'ใช่',
